...
public class ErrorDao implements Serializable{
    ...
    public static Document findoneby(String tablename, String appId, String appVersion, String appChannel,
                              String appPlatform, String timeValue,String ostype,String deviceStyle){
