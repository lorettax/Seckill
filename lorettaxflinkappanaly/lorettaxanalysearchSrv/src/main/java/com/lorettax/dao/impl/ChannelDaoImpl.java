 ...
 */
@Component
public class ChannelDaoImpl extends BaseMongo implements ChannelDao {
    ...
    public List<Channeluser> listChannelInfoby(String appId, String timeFrom, String timeTo, String timeUnit, String appChannel, String appPlatform) {
        List<Channeluser> result = new ArrayList<Channeluser>();
        ...
        if("daily".equals(timeUnit)){
            collection = db.getCollection("channeluserinfodaily");
        }else{
            return result;
        }
        ...
        while(cursor.hasNext()){
            ...
            Channeluser channeluser = JSONObject.parseObject(jsonString,Channeluser.class);
            result.add(channeluser);
        }
        return result;
    }
}
