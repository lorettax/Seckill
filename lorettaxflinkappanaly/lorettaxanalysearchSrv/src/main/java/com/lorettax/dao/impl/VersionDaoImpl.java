 ...
 */
@Component
public class VersionDaoImpl extends BaseMongo implements VersionDao {
    ...
    public List<Versionuser> listVersionInfoby(String appId, String timeFrom, String timeTo, String timeUnit, String appChannel, String appPlatform) {
        List<Versionuser> result = new ArrayList<Versionuser>();
        ...
        if("daily".equals(timeUnit)){
            collection = db.getCollection("appversionuserinfodaily");
        }else{
            return result;
        }
        ...
        while(cursor.hasNext()){
            ...
            Versionuser versionuser = JSONObject.parseObject(jsonString,Versionuser.class);
            result.add(versionuser);
        }
        return result;
    }
}
