...
//            e.printStackTrace();
    ...
    public static void main(String[] args) {
        AreabyipUtil addressUtils = new AreabyipUtil();
 // 122.49.20.247中国=华北
//        String ip = "122.49.20.247";
    ...
    public static String getAddressByIp(String ip){
        ...
        String city = "未知";
        try {
            json_result = AreabyipUtil.getAddresses("ip=" + ip, "utf-8");
        } catch (Exception e) {
//            e.printStackTrace();
        }
        ...
        if(json !=null) {
            ...
            country = jsoninner.get("country").toString();
            region = jsoninner.get("region").toString();
            city = jsoninner.get("city").toString();
            if (country.equals("XX") || country.trim().equals("")) {
                country = "未知";
                region = "未知";
                city = "未知";
            }
        }
        String result = country+"=="+region+"=="+city;
        return result;
    }
